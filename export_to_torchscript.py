...
torch.jit.save(torch.jit.script(build_efficient_sam_vit_ti()), "torchscripted_model/efficient_sam_vitt_torchscript.pt")

# Efficient SAM (VIT-small)
# Since VIT-small is >100MB, we store the zip file.
with zipfile.ZipFile("weights/efficient_sam_vits.pt.zip", 'r') as zip_ref:
    zip_ref.extractall("weights")
torch.jit.save(torch.jit.script(build_efficient_sam_vit_s()), "torchscripted_model/efficient_sam_vits_torchscript.pt")
